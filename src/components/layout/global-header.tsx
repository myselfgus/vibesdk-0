																		...
																		<div className="relative z-10 grid grid-cols-[auto_1fr_auto] items-center gap-4 px-5 py-2">
																			...
																			{user ? (
																					<motion.div
																													...
																													>
																													<SidebarTrigger className="h-8 w-8 text-foreground dark:text-background neu-icon-btn transition-colors duration-200" />
																						...
																						{hasMaintenanceMessage && (
																																							<button
																																																		...
																																																		className={`flex max-w-full items-center gap-2 border border-primary/30 bg-white/80 dark:bg-primary/80 px-3 ml-4 py-1.5 text-xs text-foreground dark:text-background shadow-sm backdrop-blur transition-colors hover:bg-accent focus:outline-none focus:ring-2 focus:ring-ring md:text-sm${!hasChangeLogs ? ' opacity-50 cursor-not-allowed pointer-events-none' : ''}`}
